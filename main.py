...
def test(model_folder, erasures_type, erasures_param, rtt, T, reps, print_flag):
    ...
    # Train folder
    pretrained_model_filename = r"{}/Train/train.pth".format(model_folder)
...
def run():
    # General Inputs:
    all_results_folder = r"/home/adina/research/Results"
    rtt = 8
    ...
    print_flag = False
    lr = 1e-4
    warm_start_filename = None # r"/home/adina/research/Results/warm_restart/Train/train.pth"
    # erasures_type = 'arb'
    ...
    # erasures_type = 'burst'
    # erasures_param = [0, 1, 0.01, 0.25]
    # train_folder = r"/home/adina/research/Results/warm_restart/"  # manually choose trained model
    #
