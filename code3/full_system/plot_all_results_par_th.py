...
class PlotAll:
    ...
    def load_results(self, rtt, scenario, pred_type, model_type=None, loss_type=None, th=None):
        ...
        if pred_type == 'MODEL':
            ...
            if model_type == 'TH':
                folder = f'{self.cfg.data.project_folder}/{self.cfg.model.results_folder}/{self.modelTH_folder}' \
